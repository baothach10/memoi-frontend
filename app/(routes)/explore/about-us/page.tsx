...
export default function AboutUsPage() {
  ...
  return (
    <div className={`min-h-dvh relative w-full bg-[#fffefa]`}>
      <section
        className="min-h-dvh h-full w-full text-black pt-36 gap-[100px] relative flex flex-col items-center text-center smaller-tablet:max-tablet:pb-20 smaller-tablet:max-tablet:gap-16 max-mobile:gap-10 max-mobile:pt-24 max-mobile:pb-10"
