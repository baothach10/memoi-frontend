...
export default function ContactUsPage() {
    ...
    return (
        <div className="min-h-dvh h-full w-full relative" data-header-theme="light">
            <section className="relative flex w-full min-h-dvh justify-center px-25 flex-col max-tablet:px-0 smaller-tablet:max-tablet:max-w-[375px] max-tablet:mx-auto max-mobile:px-5">
