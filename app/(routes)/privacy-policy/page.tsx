            ...
            <section className="px-[100px] max-tablet:px-[5%] mx-auto max-w-[1080px] pt-32 max-tablet:pt-26 pb-27 max-tablet:pb-24 max-mobile:pb-15 max-mobile:pt-24">
                ...
                <div className="flex flex-col gap-9 text-sm text-black max-mobile:text-xs max-mobile:gap-8">
                    ...
                    <div id="section-1" className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <p className={textClass}>The information we collect includes:</p>
                        <ul className="list-disc pl-6 flex flex-col gap-3 ">
                            <li className={textClass}>
                    ...
                    <div id="section-3" className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <ul className="list-disc pl-6 flex flex-col gap-3">
                            <li className={textClass}>If collection is clearly in the interests of an individual and consent cannot be obtained in a timely way</li>
                            <li className={textClass}>For investigations and fraud detection and prevention</li>
                            <li className={textClass}>For business transactions provided certain conditions are met</li>
                            <li className={textClass}>If it is contained in a witness statement and the collection is necessary to assess, process, or settle an insurance claim</li>
                            <li className={textClass}>For identifying injured, ill, or deceased persons and communicating with next of kin</li>
                            <li className={textClass}>If we have reasonable grounds to believe an individual has been, is, or may be victim of financial abuse</li>
                            <li className={textClass}>If it is reasonable to expect collection and use with consent would compromise the availability or the accuracy of the information and the collection is reasonable for purposes related to investigating a breach of an agreement or a contravention of the laws of Canada or a province</li>
                            <li className={textClass}>If disclosure is required to comply with a subpoena, warrant, court order, or rules of the court relating to the production of records</li>
                            <li className={textClass}>If it was produced by an individual in the course of their employment, business, or profession and the collection is consistent with the purposes for which the information was produced</li>
                            <li className={textClass}>If the collection is solely for journalistic, artistic, or literary purposes</li>
                            <li className={textClass}>If the information is publicly available and is specified by the regulations</li>
                            <li className={textClass}>
                    ...
                    <div id="section-12" className="flex flex-col gap-4 max-mobile:gap-3">
                            ...
                            <table className="w-full text-left text-sm max-mobile:text-xs border border-black/20" style={{ borderCollapse: 'collapse' }}>
                                ...
                                <tbody>
                                    {TABLE_DATA.map((row, index) => (
                                        <tr key={index}>
                                            <td className="border border-black/20 py-4 px-5 align-top max-mobile:px-2 max-mobile:py-2 leading-[150%]">{row.category}</td>
                                            <td className="border border-black/20 py-4 px-5 align-top max-mobile:px-2 max-mobile:py-2 leading-[150%]">{row.examples}</td>
                                            <td className="border border-black/20 py-4 px-5 align-top max-mobile:px-2 max-mobile:py-2 leading-[150%]">{row.collected}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <p className={textClass}>Depending upon the state where you live, you may also have the following rights:</p>
