            ...
            <section className="px-[100px] max-tablet:px-[5%] mx-auto max-w-[1080px] pt-32 max-tablet:pt-26 pb-27 max-tablet:pb-24 max-mobile:pb-15 max-mobile:pt-24">
                ...
                <div className="flex flex-col gap-9 text-sm text-black/80 max-mobile:text-xs max-mobile:gap-6">
                    ...
                    <div className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <p>
                            We are Memoi (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our&rdquo;), a company registered in Singapore at 10 Marina Boulevard, Singapore, Singapore 018983. Our VAT number is M90360025X.
                        </p>
                        <p>
                    ...
                    <div className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <p>
                            These Legal Terms shall be governed by and defined following the laws of Singapore. Memoi and yourself irrevocably consent that the courts of Singapore shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <p>
                            You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the Singapore courts. Memoi shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 max-mobile:gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                            <p>Memoi</p>
                            <p>10 Marina Boulevard</p>
                            <p>Singapore, Singapore 018983</p>
                            <p>Singapore</p>
                            <p>
                                <Link href="mailto:memoi@memoiofficial.com" className="cursor-pointer">
                                    memoi@memoiofficial.com
