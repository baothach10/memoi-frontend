    ...
    <div className="absolute bottom-10 left-0 right-0 z-10 px-8 max-mobile:bottom-8">
      <div className="mx-auto text-center space-y-2 max-mobile:text-sm">
        ...
        <LinkItem
          url={url}
          title={urlTitle}
          style="relative inline-flex leading-[18px] text-white cursor-pointer after:absolute after:left-0 after:-bottom-px after:h-px after:w-full after:origin-left after:scale-x-100 after:bg-white/40"
        />
