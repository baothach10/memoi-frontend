    ...
    <div className="border border-black/10 pt-10 flex flex-col gap-8 bg-transparent max-mobile:pt-6 max-mobile:gap-6">
      ...
      <div className="flex gap-8 text-xs text-black/40 px-8 max-tablet:gap-0 justify-between max-mobile:px-4">
        <div className="flex flex-col gap-1 justify-between">
          ...
          <p className="text-black text-xl font-regular max-mobile:text-lg">{order.order_number}</p>
        </div>
        ...
        {hasMoreItems ? (
          <div className="flex justify-center">
            <button
              ...
              className="text-sm text-black hover:text-black cursor-pointer transition-colors underline underline-offset-4 decoration-black/40 max-mobile:text-xs"
            >
              View more
            </button>
          </div>
      ...
      <div className="flex items-center justify-between border-t border-black/10 py-5 px-8 max-mobile:px-4 max-mobile:py-3">
        <div className="flex items-baseline gap-2 text-lg max-mobile:text-[16px] ">
        ...
        <Link 
          ...
          className="w-[200px] py-4 leading-none border border-black/10 text-sm cursor-pointer hover:bg-black hover:text-white transition-all max-mobile:w-[120px] max-mobile:text-xs text-center max-mobile:py-3"
        >
          View details
        </Link>
      </div>
