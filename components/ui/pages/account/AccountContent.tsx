      ...
      {/* RIGHT – CONTENT */}
      {
        activeSection === "profile" && (
          <div className="col-span-6 max-tablet:col-span-1 flex flex-col gap-9 max-tablet:gap-0">
            ...
            <div className="hidden max-tablet:flex max-tablet:mt-9 max-tablet:mb-16 max-mobile:mt-6 max-mobile:mb-9 max-tablet:flex-col max-tablet:gap-10 max-mobile:gap-4">
              <AccountNavigation active={activeSection} setActive={setActiveSection} />
            ...
            <div className="flex flex-col gap-20">
              ...
              <DeleteAccountSection onDelete={() => setIsDeleteModalOpen(true)} />
            </div>
          </div>
        )
      }
