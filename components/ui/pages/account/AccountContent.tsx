...
export default function AccountContent({ userProfile }: AccountContentProps) {
  ...
  return (
    <div className="w-3/4 grid grid-cols-10 max-tablet:grid-cols-1 gap-32 max-tablet:gap-10 pt-32 max-tablet:pt-26 pb-27 max-tablet:pb-24 max-mobile:pb-15 max-mobile:pt-16">
