...
export default function DeleteAccountSection({ onDelete }: { onDelete: () => void }) {
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <p className="text-sm text-black/80 leading-relaxed font-light mt-8">
        ...
        <Link href={"/"} className="text-sm inline text-black/80 relative underline decoration-black/40 cursor-pointer max-mobile:text-xs">
          Privacy Policy
        </Link>
      </p>
    </div>
